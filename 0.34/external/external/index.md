...
There are different storage protocols, such as [*hash*](#hash) or [*uuid*](#uuid), and different file formats, such as *.txt*, *.bin*, and *.json*. It is also possible to implement [*custom*](https://15r10nk.github.io/inline-snapshot/0.34/external/register_format/index.md) file formats.
...
[Custom formats](https://15r10nk.github.io/inline-snapshot/0.34/external/register_format/index.md) are also supported.
