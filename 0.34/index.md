...
You can learn [here](https://15r10nk.github.io/inline-snapshot/0.34/fix_assert/index.md) more about this feature.
...
- [`value == snapshot()`](https://15r10nk.github.io/inline-snapshot/0.34/eq_snapshot/index.md) to compare with something,
- [`value <= snapshot()`](https://15r10nk.github.io/inline-snapshot/0.34/cmp_snapshot/index.md) to ensure that something gets smaller/larger over time (number of iterations of an algorithm you want to optimize for example),
- [`value in snapshot()`](https://15r10nk.github.io/inline-snapshot/0.34/in_snapshot/index.md) to check if your value is in a known set of values,
- [`snapshot()[key]`](https://15r10nk.github.io/inline-snapshot/0.34/getitem_snapshot/index.md) to generate new sub-snapshots on demand.
