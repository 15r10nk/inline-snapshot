...
For large values this currently works with `external()` + `outsource()`, and the
UUID file names are generated by inline-snapshot.
...
external_snapshots = snapshot(
    {
        "[1]*10": external("uuid:11111111-1111-4111-8111-111111111111.json"),
        "[2]*10": external("uuid:22222222-2222-4222-8222-222222222222.json"),
        "[1]*20": external("uuid:33333333-3333-4333-8333-333333333333.json"),
        "[2]*20": external("uuid:44444444-4444-4444-8444-444444444444.json"),
    }
)
