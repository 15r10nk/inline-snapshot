...
external_snapshots = snapshot(
    {
        "[1]*10": external("uuid:<auto-generated-1>.json"),
        "[2]*10": external("uuid:<auto-generated-2>.json"),
        "[1]*20": external("uuid:<auto-generated-3>.json"),
        "[2]*20": external("uuid:<auto-generated-4>.json"),
    }
)
