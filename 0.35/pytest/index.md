...
Approve the changes for the given [category](https://15r10nk.github.io/inline-snapshot/0.35/categories/index.md). These flags can be combined with *report* and *review*.
...
The [default flags](https://15r10nk.github.io/inline-snapshot/0.35/configuration/#default-flags) when you are in an interactive terminal are `--inline-snapshot=create,review` (or `--inline-snapshot=short-report` when you are using *CPython 3.10 or older*).
