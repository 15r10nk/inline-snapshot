...
There are different storage protocols, such as [*hash*](#hash) or [*uuid*](#uuid), and different file formats, such as *.txt*, *.bin*, and *.json*. It is also possible to implement [*custom*](https://15r10nk.github.io/inline-snapshot/0.35/external/register_format/index.md) file formats.
...
[Custom formats](https://15r10nk.github.io/inline-snapshot/0.35/external/register_format/index.md) are also supported.
...
If this file does not exist yet, inline-snapshot falls back to scanning [`test-dir`](https://15r10nk.github.io/inline-snapshot/0.35/configuration/#test-dir) to discover existing external snapshots and writes the tracked file list for future runs.
