...
def test_a():
    s=snapshot(external("uuid:e3e70682-c209-4cac-a29f-6fbed82c07cd.txt"))
    assert outsource("test") == s
...
tests/test_something.py
""",
            "tests/__inline_snapshot__/test_something/test_a/e3e70682-c209-4cac-a29f-6fbed82c07cd.bin": "test",
            "tests/test_something.py": """\
from inline_snapshot import external, snapshot, outsource

def test_a():
    s=snapshot(external("uuid:e3e70682-c209-4cac-a29f-6fbed82c07cd.bin"))
    assert outsource(b"test") == s
...
tests/test_something.py
""",
                "tests/__inline_snapshot__/test_something/test_something/e3e70682-c209-4cac-a29f-6fbed82c07cd.txt": "test",
                "tests/test_something.py": """\
...
tests/test_something.py
""",
            "tests/__inline_snapshot__/test_something/test_a/e3e70682-c209-4cac-a29f-6fbed82c07cd.txt": "testabc",
            "tests/test_something.py": """\
from inline_snapshot import snapshot,outsource
...
def test_a():
    assert outsource("testabc") == snapshot(external("uuid:e3e70682-c209-4cac-a29f-6fbed82c07cd.txt"))
