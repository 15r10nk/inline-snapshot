...
def write_external_source_files(files: set[Path]):
    ...
    header = "# this file is generated by inline-snapshot and needs no manual edits (https://15r10nk.github.io/inline-snapshot/latest/external/external/#cleaning-up-old-externals)\n"
