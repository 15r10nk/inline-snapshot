...
Other types are converted with a [customizable](https://15r10nk.github.io/inline-snapshot/0.33/customize_repr/index.md) `repr()` into code. It is not possible to use unmanaged snapshot values within these objects.
